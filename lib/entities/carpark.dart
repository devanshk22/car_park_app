...
class CarparkDataHandler extends Carpark {
  ...
  CarparkDataHandler.fromJson(Map json)
      : this(
            ...
            address:
                (json[carparkInfoConst.address] as String).capitalizeEachWord(),
            carparkType: (json[carparkInfoConst.carparkType] as String)
                .capitalizeEachWord(),
            parkingSystem: (json[carparkInfoConst.parkingSystem] as String)
                .capitalizeEachWord(),
            shortTermParking:
                (json[carparkInfoConst.shortTermParking] as String)
                    .capitalizeEachWord(),
            freeParking: (json[carparkInfoConst.freeParking] as String)
                .capitalizeEachWord(),
            nightParking: (json[carparkInfoConst.nightParking] as String)
                .capitalizeEachWord(),
            carparkBasement: (json[carparkInfoConst.carparkBasement] as String)
                .formatYesNo(),
